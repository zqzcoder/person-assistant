...
public class AttendanceAdapter extends BaseAdapter<Application>{

	public AttendanceAdapter(Context context, List<Application> data) {
		super(context, data);
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (null == convertView) {
			...
			convertView = getLayoutInflater()
				.inflate(R.layout.contact_item_attendance, null);
